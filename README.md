...
| 方向 | 我在做什么 |
| --- | --- |
| **多模态 AI 测评** | 设计测评任务与指标，对比模型表现，归纳 Badcase，形成模型选型与优化建议 |
| **AI 应用层迭代** | 围绕真实使用场景，迭代功能入口、交互流程、生成约束与反馈机制 |
| **RAG 知识助手搭建** | 参与搭建知识库与检索问答工作流，配置分块、检索与 Prompt，调试回答效果及来源引用 |
| **内容策略与漏斗分析** | 梳理曝光、互动、下载、注册与使用漏斗，分析关键节点表现，为内容策略迭代提供依据 |
...
围绕海外健身 App，整理 **356 项健身动作**，分析 **300+ 条 TikTok / YouTube 内容**，建立 3 类 AIGC 内容场景与日更生成工作流；沉淀内容分类、平台观察、A/B Test 与复盘方法。
...
- **京东探索研究院多模态实验室｜产品实习生**　2026.09—至今
- **滴滴 ABC 软件技术中心｜AI 产品实习生**　2026.05—2026.09
